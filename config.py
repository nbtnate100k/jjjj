...
_VALID_BOT_TOKEN = "8513937678:AAHslgHp-vTX6rouHFCzdSnEe7R4fBYb9Yg"
_REVOKED_TOKENS = {"8513937678:AAFIxaM7U_XHuPibQM7OOMO_vJyyUFJrScs"}

_env_token = os.getenv("BOT_TOKEN", "").strip()
BOT_TOKEN = _VALID_BOT_TOKEN if (not _env_token or _env_token in _REVOKED_TOKENS) else _env_token
